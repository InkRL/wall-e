"""
Wall-E local benchmark — runs the same 5 tasks against any Ollama model.
No promptfoo required. Compares baseline vs caveman vs wall-e on code LOC
...
def load_arms():
    return {
        ...
        "wall-e": (ROOT / "skills/wall-e/SKILL.md").read_text(encoding="utf-8"),
    }
...
def main():
    parser = argparse.ArgumentParser(description="Wall-E local benchmark via Ollama")
