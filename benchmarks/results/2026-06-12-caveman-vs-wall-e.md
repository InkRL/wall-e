...
## Wall-E v1 (before this benchmark)

| Task | Baseline | Caveman | Wall-E v1 |
|---|---|---|---|
...
1. Code minimalism: wall-e dominated (2.2× fewer lines than caveman, 5.5× fewer than baseline).
2. Total tokens: caveman won by ~4% — wall-e wrote minimal code, then long
   "skipped on purpose" essays. Prose ate the code savings.
3. Speed: caveman 136s vs wall-e 228s — wall-e deliberated about what not to build.
4. Floor effect: on already-minimal tasks (csv-sum) both skills pay ~3k tokens
   skill-read tax over baseline.

## Wall-E v2 (after fixes)
...
| Task | Wall-E v2 | Δ vs v1 | Δ vs caveman |
|---|---|---|---|
...
## Wall-E v3 (skill file compressed)
...
| Task | Wall-E v3 | Δ vs v2 | Δ vs caveman |
|---|---|---|---|
...
| Area | Winner |
|---|---|
| Code size | **Wall-E** — 47 vs 117 lines (2.5×) |
| Deliverable prose | **Wall-E** — capped at 3 skip-lines, under caveman's gotcha lists |
| Total tokens (cost) | **Wall-E** — 135.7k vs 138.4k (−2.0%) |
| Wall time | **Wall-E** — 127s vs 136s (−7%; n=1, treat as parity-or-better) |
| Follow-up prevention | **Wall-E** — every skip names its escalation trigger |
