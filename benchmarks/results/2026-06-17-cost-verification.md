...
Context: the README headline says wall-e is "47-77% cheaper." This is a fresh
...
- On Claude, wall-e is **42-75% cheaper** than no-skill across Haiku, Sonnet, and Opus
...
- Correctness is not hurt anywhere: wall-e scores **100%** on every Claude and OpenAI
...
Three arms (no skill, caveman, wall-e) on Claude; baseline vs wall-e on OpenAI. Five
...
| model | baseline | caveman | wall-e | wall-e vs baseline |
|---|--:|--:|--:|--:|
| Haiku | 0.0299 | 0.0139 | 0.0110 | **63.1% cheaper** |
| Sonnet | 0.1367 | 0.0458 | 0.0348 | **74.5% cheaper** |
| Opus | 0.1368 | 0.0724 | 0.0789 | **42.3% cheaper** |

**Range: 42-75% cheaper** (vs the published 47-77%). Latency 3.1-5.8x faster; wall-e
correctness 100% on all three.

### OpenAI (10 reps, USD for 5 tasks)

| model | baseline | wall-e | wall-e vs baseline | latency | correctness |
|---|--:|--:|--:|--:|--:|
...
The reasoning models (gpt-5.4-mini, gpt-5.5) cost more under wall-e: the ruleset is
...
gemini-3.1-pro-preview (top), baseline vs wall-e.
...
models, including the newest top model gpt-5.5, wall-e costs more, not less. The number is
