...
// so it cannot be byte-compared. wall-e: canary, not full equality. Assert the
...
const skill = read('skills/wall-e/SKILL.md');
const sources = [['skills/wall-e/SKILL.md', skill], ['AGENTS.md', agents]];
