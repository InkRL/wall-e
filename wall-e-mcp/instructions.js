// Pure instruction selection for the Wall-E MCP server. No MCP/SDK imports,
...
const { getWallEInstructions } = require("../hooks/wall-e-instructions.js");
const { getDefaultMode, normalizeMode } = require("../hooks/wall-e-config.js");
...
// wall-e: keep the surface to these three; "off"/"review" aren't served here.
...
export function buildInstructions(requested) {
  return getWallEInstructions(resolveMode(requested));
}
