#!/usr/bin/env node
// Wall-E MCP server: serves the lazy-senior-dev ruleset over stdio as a
...
const server = new McpServer({ name: "wall-e", version: "0.1.0" });

const modeArg = z
  .enum(MODES)
  .optional()
  .describe("Wall-E intensity: lite, full, or ultra. Omit for the configured default.");
...
server.registerTool(
  "walle_instructions",
  {
    title: "Wall-E instructions",
    description: "Return the Wall-E ruleset for the given intensity (lite, full, or ultra).",
